...
class GismeteoLoader(UrlLoader):
    ...
    def _parse(self, soup: BeautifulSoup):
        ...
        night_t = today_info[0].contents[0].contents[0].contents[2].contents[0].contents[0].contents[0].contents[0].contents[0]
        day_t = today_info[0].contents[0].contents[0].contents[2].contents[0].contents[0].contents[1].contents[0].contents[0]
